...
I am a third-year Ph.D. student in Computer and Information Science at the [University of Oregon](https://www.uoregon.edu/). I have been working with Professor [Thien Huu Nguyen](https://ix.cs.uoregon.edu/~thien/) in the [UONLP lab](http://nlp.uoregon.edu/) in Multilingual Natural Language Processing with the focus on Information Extraction, whose goal is to develop systems for extracting structured information from unstructured text in different languages. Two recent notable projects where I am the lead author are [Trankit](https://github.com/nlp-uoregon/trankit) (a state-of-the-art multilingual NLP toolkit for 56 languages) and [FourIE](http://nlp.uoregon.edu/fourie) (a state-of-the-art multilingual joint IE system for English, Chinese, and Spanish). I am also the main research assistant for the IARPA’s BETTER project where I have been building systems to extract events and arguments in Arabic and Farsi text. 
